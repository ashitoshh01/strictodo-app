...
const SignUp = () => {
  ...
  useEffect(() => {
    ...
    if (urlParams.get('verified') === 'true') {
      ...
      toast({
        ...
        description: "Your email has been verified. Please complete the security verification below.",
      });
    }
  }, [toast]);

  useEffect(() => {
    // Only load CAPTCHA script when needed
  ...
  const handleContinueToSignUp = () => {
    if (!isEmailVerified) {
      toast({
        ...
        description: "Please verify your email first by clicking the link we sent you.",
        variant: "destructive",
      });
      return;
    }
  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      console.log('Signing up with CAPTCHA token:', captchaToken);
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <Card className="w-full max-w-md mx-auto shadow-xl">
          <CardHeader className="space-y-2">
            ...
            <CardDescription className="text-center">
              {!isVerificationSent ? 
                ...
                "Complete security verification to finish"
              }
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            {isVerificationSent && !isEmailVerified && (
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  We've sent a verification link to <strong>{watchedEmail}</strong>. 
                  Click the link in your email to continue with sign up.
                </p>
                <Button
                  type="button"
                  variant="outline"
            ...
            {/* Email Verified - Continue Button */}
            {isEmailVerified && !showCaptcha && (
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Your email has been verified. Continue to complete your account setup.
                </p>
                <Button
                  type="button"
            ...
            {showCaptcha && (
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email-confirmed">Email (Verified)</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="email"
                      value={watchedEmail}
                      className="pl-10 pr-10 bg-green-50 border-green-200"
                      {...register('email')}
                      disabled
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-center min-h-[80px] border border-input rounded-md p-4 bg-muted/20">
                    {!isCaptchaLoaded ? (
            ...
            {/* OAuth Options - Show only if not in email verification flow */}
            {!isVerificationSent && (
              <>
                <div className="relative">
